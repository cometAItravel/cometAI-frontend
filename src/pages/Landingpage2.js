...
export default function LandingPage2(){
  ...
  return(
    <>
      ...
      <div style={{position:"fixed",inset:0,zIndex:100,background:"#ffffff",transform:lifting?"translateY(-100%)":"translateY(0%)",transition:lifting?"transform 1.8s cubic-bezier(0.76,0,0.24,1)":"none",pointerEvents:introDone?"none":"all",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:0}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:56,alignItems:"flex-start"}} className="g2">
            <Reveal direction="left">
              <div style={{borderRadius:24,overflow:"hidden",border:"1px solid rgba(255,255,255,0.06)",background:"rgba(0,0,0,0.48)",backdropFilter:"blur(20px)"}}>
                ...
                <div style={{padding:"20px",display:"flex",flexDirection:"column",gap:12}}>
                  {[{role:"user",text:"6 friends Bangalore to Goa in August. Budget 15k per person. Two vegetarians. One arrives a day late. Prefer beaches."},{role:"ai",text:"Perfect! Planning this right now for all 6 of you."},{role:"ai",text:"Flights BLR to GOI: 3500-4500 per person return. Book 4-6 weeks early for best fares. For 6 total: 21000-27000."},{role:"ai",text:"South Goa near Palolem and Agonda. Budget 800-1800 per room. Veg restaurants specifically picked. Late arrival has separate plan.",card:true}].map((m,i)=>(
            ...
            <Reveal direction="right" delay={100}>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:36}}>
                {[{icon:"\ud83d\udc65",t:"Group of 6",d:"Per person and total budget breakdown"},{icon:"\ud83e\udd57",t:"2 Vegetarians",d:"Specific restaurant picks in South Goa"},{icon:"\ud83d\udd50",t:"Late arrival",d:"Separate travel plan auto-created"},{icon:"\ud83c\udfd6\ufe0f",t:"Beaches only",d:"South Goa recommended over North Goa"},{icon:"\ud83d\udcb0",t:"15k budget",d:"Confirmed: fits at 11500-14500 per person"},{icon:"\ud83d\udee1\ufe0f",t:"Safety insights",d:"Goa safety tips automatically included"}].map((f,i)=>(
      ...
      <section id="s-plans" style={{background:"#f2eee8",padding:"120px 6%",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{maxWidth:1000,margin:"0 auto",position:"relative",zIndex:2}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:20}} className="g3">
            {[{name:"Explorer",badge:"FREE \u00b7 LIVE",active:true,desc:"Everything to start your journey",features:["20 AI responses per day","2 complete trip plans per month","Flights, buses and hotels","Safety insights auto-included","WhatsApp ALVI access"],cta:"Start Free"},{name:"Navigator",badge:"PRO",active:false,desc:"For the serious traveller",features:["Unlimited trip plans","Advanced AI planning","Budget optimizer","Multi-city planning","Priority responses","Trip history"],cta:"Coming Soon"},{name:"Voyager",badge:"PREMIUM",active:false,desc:"The ultimate companion",features:["Everything in Navigator","Group travel planner","Scam protection alerts","Women traveller mode","Emergency companion","Real-time weather"],cta:"Coming Soon"}].map((p,i)=>(
