...
const styles = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .stars-bg {
    ...
    pointer-events: none;
    background:
      radial-gradient(ellipse at 20% 50%, rgba(63,43,150,0.18) 0%, transparent 60%),
      radial-gradient(ellipse at 80% 20%, rgba(25,90,180,0.14) 0%, transparent 55%),
      radial-gradient(ellipse at 60% 80%, rgba(100,30,140,0.12) 0%, transparent 50%),
      #01020a;
  }
