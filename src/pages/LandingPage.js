...
export default function LandingPage() {
  ...
  return (
    <>
      ...
      {/* PAGE */}
      <div style={{ opacity: splashDone ? 1 : 0, transition:"opacity 0.6s ease", background:T.bg, transition:"background 1.5s ease, opacity 0.6s ease" }}>
          ...
          <div style={{ position:"relative", zIndex:2, maxWidth:900, margin:"0 auto" }}>
            ...
            <div className="how-grid" style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:28 }}>
              {[
                ...
                { n:"02", icon:"\u26A1", title:"We compare and rank results", desc:"Alvryn searches across our partner network — trusted travel partners across flights, buses and hotels. Results are ranked by price and value so you decide in seconds.", sub:["Live fares from airline partners","Bus schedules from RedBus network","Hotels from Booking.com globally"] },
